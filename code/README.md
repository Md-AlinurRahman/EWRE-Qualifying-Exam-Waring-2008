...
This folder contains R scripts used to reproduce the figures presented in the EWRE Qualifying Exam presentation.

The scripts use data transcribed from Waring et al. (2008).
...
Figures were generated using R and RStudio.
